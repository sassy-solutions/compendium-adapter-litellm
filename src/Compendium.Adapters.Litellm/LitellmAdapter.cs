// -----------------------------------------------------------------------
// <copyright file="LitellmAdapter.cs" company="Sassy Solutions">
...
namespace Compendium.Adapters.Litellm;

/// <summary>
/// Litellm adapter — replace with the real vendor implementation.
...
/// </list>
/// </summary>
public sealed class LitellmAdapter
{
    private readonly LitellmOptions _options;
    private readonly ILogger<LitellmAdapter> _logger;

    /// <summary>
    /// Creates a new <see cref="LitellmAdapter"/>.
    /// </summary>
    /// <param name="options">Adapter configuration.</param>
    /// <param name="logger">Diagnostic logger.</param>
    public LitellmAdapter(IOptions<LitellmOptions> options, ILogger<LitellmAdapter> logger)
    {
